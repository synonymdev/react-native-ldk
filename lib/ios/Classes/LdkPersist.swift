...
class LdkPersister: Persist {
    ...
    private func handleChannel(_ channel_id: OutPoint, _ data: ChannelMonitor, isNew: Bool = false) -> Result_NoneChannelMonitorUpdateErrZ {
    ...
    override func persist_new_channel(channel_id: OutPoint, data: ChannelMonitor, update_id: MonitorUpdateId) -> Result_NoneChannelMonitorUpdateErrZ {
        return handleChannel(channel_id, data, isNew: true)
    }
