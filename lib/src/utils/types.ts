...
export type TChannel = {
	...
	balance_sat: number;
	counterparty_node_id: string;
	counterparty_outbound_htlc_maximum_msat?: number;
	counterparty_outbound_htlc_minimum_msat?: number;
	counterparty_forwarding_info_fee_base_msat: number;
	counterparty_forwarding_info_fee_proportional_millionths: number;
	counterparty_forwarding_info_cltv_expiry_delta: number;
	counterparty_features_initial_routing_sync: boolean;
	counterparty_features_requires_basic_mpp: boolean;
	counterparty_features_requires_channel_type: boolean;
	counterparty_features_requires_data_loss_protect: boolean;
	counterparty_features_requires_gossip_queries: boolean;
	counterparty_features_requires_payment_secret: boolean;
	counterparty_features_requires_scid_privacy: boolean;
	counterparty_features_requires_shutdown_anysegwit: boolean;
	counterparty_features_requires_static_remote_key: boolean;
	counterparty_features_requires_unknown_bits: boolean;
	funding_txo?: string;
	channel_type?: string;
	user_channel_id: number;
